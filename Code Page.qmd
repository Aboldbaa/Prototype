...
ggplot(laborTable) +
  # Blue bar for total graduates
  geom_col(aes(x = reorder(Bachelor.s.degree, Total), y = Total), 
           fill = "yellow") +
  
  # Grey overlay showing % employed (scaled)
  ...
  labs(
    title = "Labor Force Status of 2024 Degree Recipients (Ages 20–29)",
  ...
  # Format y-axis with commas (1,000,000 → easier to read)
